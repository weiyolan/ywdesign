      ...
      <div className='relative w-full h-fit flex flex-col '> 
        ...
        className='relative w-full px-4 left-1/2' viewBox="0 0 807 563" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <g id="projectDefinitionGroup">
              ...
              <TextAnimate at={0.06} fromTop={true} id="Scope" fill="black" style="white-space: pre" font-family="Work Sans" font-size="37.1769" letter-spacing="0em"><tspan x="104.162" y="553.77">Scope</tspan></TextAnimate>
              
              <TextAnimate at={0.07} fromTop={true} id="Timing" fill="black" style="white-space: pre" font-family="Work Sans" font-size="37.1769" letter-spacing="0em"><tspan x="343.078" y="553.77">Timing</tspan></TextAnimate>
              
              <TextAnimate at={0.08} fromTop={true} id="Budget" fill="black" style="white-space: pre" font-family="Work Sans" font-size="37.1769" letter-spacing="0em"><tspan x="585.092" y="553.77">Budget</tspan></TextAnimate>
