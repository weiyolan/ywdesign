      ...
      <div className='relative w-full h-fit flex flex-col '> 
        ...
        className='relative w-full px-4 left-1/2' viewBox="0 0 807 563" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <g id="projectDefinitionGroup">
              <AnimateSVGText at={0.04} fromTop={true}>
                <Text id="Project Definition" fill="black" style="white-space: pre" font-family="Work Sans" font-size="44.0504" font-weight="500" letter-spacing="0em"><tspan x="213.791" y="333.131">Project Definition</tspan></Text>
              </AnimateSVGText>
              ...
              <AnimateSVGText at={0.06} fromTop={false}>
                <Text id="Scope" fill="black" style="white-space: pre" font-family="Work Sans" font-size="37.1769" letter-spacing="0em"><tspan x="104.162" y="553.77">Scope</tspan></Text>
              </AnimateSVGText>
              
              <AnimateSVGText at={0.07} fromTop={false}>
                <Text id="Timing" fill="black" style="white-space: pre" font-family="Work Sans" font-size="37.1769" letter-spacing="0em"><tspan x="343.078" y="553.77">Timing</tspan></Text>
              </AnimateSVGText>
              
              <AnimateSVGText at={0.08} fromTop={false}>
                <Text id="Budget" fill="black" style="white-space: pre" font-family="Work Sans" font-size="37.1769" letter-spacing="0em"><tspan x="585.092" y="553.77">Budget</tspan></Text>
              </AnimateSVGText>
