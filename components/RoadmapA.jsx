      ...
      <div className='relative w-full h-fit flex flex-col '> 
        ...
        className='relative w-full px-4 left-1/2' viewBox="0 0 807 563" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <g id="projectDefinitionGroup" className="text-right">
              <TextAnimate print={false} at={0.04} fromTop={true} id="Project Definition" fill="black" style="white-space: pre" font-family="Work Sans" font-size="44.0504" font-weight="500" letter-spacing="0em"><tspan x="50%" y="333.131" textAnchor='middle'>Project Definition</tspan></TextAnimate>
              ...
              <TextAnimate at={0.06} fromTop={true} id="Scope" fill="black" style="white-space: pre" font-family="Work Sans" font-size="37.1769" letter-spacing="0em"><tspan x="160" y="553.77" textAnchor="middle">Scope</tspan></TextAnimate>
              ...
              <TextAnimate at={0.07} fromTop={true} id="Timing" fill="black" style="white-space: pre" font-family="Work Sans" font-size="37.1769" letter-spacing="0em"><tspan x="402.5" y="553.77" textAnchor="middle">Timing</tspan></TextAnimate>
              ...
              <TextAnimate at={0.08} fromTop={true} id="Budget" fill="black" style="white-space: pre" font-family="Work Sans" font-size="37.1769" letter-spacing="0em"><tspan x="645" y="553.77" textAnchor="middle">Budget</tspan></TextAnimate>
