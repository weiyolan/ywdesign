...
export default function SpecialtyCard({title, text, clicked, setClicked, noBlur, link, linkText}) {
    ...
    return (
      // variants={cardMotion}
      <div className={`flex  absolute h-full w-full flex-col select-none bg-white/10 
      ...
      shadow-md 
      after:shadow-2xl after:shadow-black after:top-0 after:left-0 after:absolute after:z-[-1] after:w-full after:h-full after:transition-all after:duration-1000 
        ${clicked? 
