...
w-5 h-5 sm:w-8 sm:h-8 */}
      ...
      className={`w-8 h-8 sm:w-10 sm:h-10 p-1 flex ${offset?'mr-2 ':'ml-2 '} aspect-square sm:my-4 justify-center items-center rounded-lg sm:rounded-xl outline-none -outline-offset-2 min-[420px]:outline-white  `}>
        {icon}
      </motion.div>
      <div>
