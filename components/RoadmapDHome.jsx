...
import { PathFillText, AnimateIn, TextAnimate } from './pathUtils'
import { SVGWrapper } from "./ContextSVG"

export default function RoadmapDHome({ scrollMin, print, scrollMax, speed , home, hovering}) {
    ...
    return (
      ...
      <SVGWrapper myRatio={allRatios} prevRatio={allPrevRatios} scrollMin={scrollMin} scrollMax={scrollMax} animationSpeed={speed}>
        <div className='relative w-full h-fit flex flex-col '>
          ...
          <svg alt='Roadmap showcase' className={`relative w-full ${home?'mb-1':'mb-4'} left-1/2`} style={{ transform: `translate(-50%, ${-0 * scrolled}px)` }} viewBox="0 0 810 1116" fill="none" xmlns="http://www.w3.org/2000/svg">
          <g id="Frame 19">
          <g id="iterationGroup">
          <PathFillText scrolled={hovering?1:false} home={home} strokeColor={hovering?'#ffffff83':'white'} position={11}  inverse={false}  double={1} handleLength={(l,i)=>handleLength(1,l,i)} id="Tri10" d="M382.506 764.69L465.074 836.031L362.007 871.866L382.506 764.69Z" stroke="white" strokeWidth="4"/>
          <PathFillText scrolled={hovering?1:false} home={home} strokeColor={hovering?'#ffffff83':'white'} position={10}  inverse={false}  double={1} handleLength={(l,i)=>handleLength(0.2,l,i)} id="Tri9" d="M368.194 611.234L393.728 735.945L272.958 695.702L368.194 611.234Z" stroke="white" strokeWidth="4" initialDash="35 10"/>
          <PathFillText scrolled={hovering?1:false} home={home} strokeColor={hovering?'#ffffff83':'white'} position={9}  inverse={false}  double={1} handleLength={(l,i)=>handleLength(0.2,l,i)} id="Tri8" d="M545.009 576.802C548.778 576.02 551.98 579.612 550.773 583.266L518.327 681.495C517.119 685.15 512.408 686.127 509.847 683.254L441.002 606.041C438.44 603.168 439.949 598.599 443.718 597.817L545.009 576.802Z" stroke="white" strokeWidth="4" initialDash="20 10"/>
          <PathFillText scrolled={hovering?1:false} home={home} strokeColor={hovering?'#ffffff83':'white'} position={8}  inverse={false}  double={1} handleLength={(l,i)=>handleLength(0.2,l,i)} id="Tri7" d="M495.128 446.659C500.514 443.422 507.357 447.373 507.248 453.656L505.913 530.043C505.807 536.138 499.194 539.879 493.914 536.831L429.763 499.793C424.483 496.745 424.417 489.148 429.643 486.008L495.128 446.659Z" stroke="white" strokeWidth="4" initialDash="20 10"/>
          <PathFillText scrolled={hovering?1:false} home={home} strokeColor={hovering?'#ffffff83':'white'} position={7}  inverse={false}  double={1} handleLength={(l,i)=>handleLength(0.2,l,i)} id="Tri6" d="M377.385 388.989C386.718 383.601 398.385 390.336 398.385 401.113L398.385 469.927C398.385 480.704 386.718 487.44 377.385 482.051L317.791 447.645C308.457 442.256 308.457 428.784 317.791 423.396L377.385 388.989Z" stroke="white" strokeWidth="4" initialDash="10 10"/>
          <PathFillText scrolled={hovering?1:false} home={home} strokeColor={hovering?'#ffffff83':'white'} lineSpeed={1.2} position={5}  inverse={false}  double={1} handleLength={(l,i)=>handleLength(0.1,l,i)} id="Arrow" d="M407.5 346C407.5 464.5 606 425 606 517.5C606 610 250.5 558 250.5 669.5C250.5 781 484 741 484 805C484 869 380.5 869 380.5 916.5C380.5 964 406.5 964 406.5 1055M406.5 1055L412 1047.5M406.5 1055L400.5 1047.5" myGradient="url(#paint0_linear_652_2278)" strokeWidth="3" strokeLinecap="round" initialDash="6 6"/>
          
            <TextAnimate at={home?hovering?0:0.28:0.41} fromTop={true} id="Iteration" transform="translate(477 335)" fill="black" style="white-space: pre" font-family="Work Sans" font-size="44.0504" font-weight="500" letter-spacing="0em"><tspan x="0.0276794" y="41.1313">{`${locale==='en'?'Iteration':'Itération'}`}</tspan></TextAnimate>

          <PathFillText print={print} scrolled={hovering?1:false} home={home} strokeColor={hovering?'#ffffff83':'white'} position={6}  inverse={false}  double={1} handleLength={(l,i)=>handleLength(0.2,l,i)} id="Tri5" d="M272.216 403.651C259.576 411.009 243.71 401.924 243.658 387.298L243.476 335.805C243.424 321.179 259.225 311.982 271.918 319.25L316.603 344.839C329.295 352.107 329.36 370.389 316.719 377.747L272.216 403.651Z" stroke="white" strokeWidth="4" initialDash="10 10"/>
          <PathFillText scrolled={hovering?1:false} home={home} strokeColor={hovering?'#ffffff83':'white'} position={4}  inverse={false}  double={1} handleLength={(l,i)=>handleLength(0.2,l,i)} id="Tri4" d="M351.517 338.905C339.236 339.85 330.538 327.147 335.859 316.039L356.852 272.216C362.174 261.108 377.524 259.926 384.483 270.089L411.938 310.181C418.898 320.344 412.246 334.229 399.965 335.174L351.517 338.905Z" stroke="white" strokeWidth="4" initialDash="10 10"/>
          <PathFillText scrolled={hovering?1:false} home={home} strokeColor={hovering?'#ffffff83':'white'} position={3}  inverse={false}  double={1} handleLength={(l,i)=>handleLength(0.2,l,i)} id="Tri3" d="M444.56 190.285C460.56 181.047 480.56 192.594 480.56 211.069L480.56 237.05C480.56 255.525 460.56 267.072 444.56 257.835L422.06 244.844C406.06 235.607 406.06 212.513 422.06 203.275L444.56 190.285Z" stroke="white" strokeWidth="4" initialDash="5 10"/>
          <PathFillText scrolled={hovering?1:false} home={home} strokeColor={hovering?'#ffffff83':'white'} position={2}  inverse={false}  double={1} handleLength={(l,i)=>handleLength(0.2,l,i)} id="Tri2" d="M358.56 149.285C374.56 140.047 394.56 151.594 394.56 170.069L394.56 196.05C394.56 214.525 374.56 226.072 358.56 216.835L336.06 203.844C320.06 194.607 320.06 171.513 336.06 162.275L358.56 149.285Z" stroke="white" strokeWidth="4" initialDash="5 10"/>
          <PathFillText scrolled={hovering?1:false} home={home} strokeColor={hovering?'#ffffff83':'white'} print={false} position={1}  inverse={false}  double={1} handleLength={(l,i)=>handleLength(0.2,l,i)} id="Tri1" d="M388.31 74.7798C409.31 62.6554 435.56 77.8109 435.56 102.06V102.06C435.56 126.308 409.31 141.464 388.31 129.339V129.339C367.31 117.215 367.31 86.9042 388.31 74.7798V74.7798Z" stroke="white" strokeWidth="4" initialDash="5 20"/>
