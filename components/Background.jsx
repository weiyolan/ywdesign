...
export default function Background ({scrolled}) {
  ...
  return (
    <div className={`-z-[50] w-full fixed top-0 h-screen overflow-hidden filter bg-cover bg-[url('/images/background.svg')] sm:bg-none`} >
      ...
      {width>breakPointSmall && 
        <div className={`bg-green ${myWidth<640?'':'animate-blob'} animation-delay-2000   
          ...
          /> }
          {width>breakPointSmall && <div className={`bg-blue ${myWidth<640?'':'animate-blob2'} animation-delay-4000   
          h-[200vh] w-[66vw] 
          right-[25vw] -top-[33vh] 
          transition-all duration-400 rounded-full filter absolute ${blurOn?`blur-[200px]`:''} `}
          />}
           {width>breakPointSmall &&<div style={myWidth<640?{top:0,left:0}:{top:`${-60+25*scrolled}vh`, left:`${-33+30*scrolled}vw`}} 
        className={`bg-green ${myWidth<640?'':'animate-blob'} animation-delay-6000   
          ...
          /> }
          {width>breakPointSmall && <div className={`bg-green ${myWidth<640?'':'animate-blob2'} animation-delay-2000  
          h-[200vh] w-[66vw] 
          right-[0] -bottom-[60vh]
          transition-all duration-400 rounded-full filter absolute ${blurOn?`blur-[200px]`:''} `}
          /> }

          {width>breakPointSmall &&<div style={myWidth<640?{}:{bottom:`${-100+20*scrolled}vh`, right:`${-25+50*scrolled}vw`}}
        className={`bg-blue ${myWidth<640?'':'animate-blob'} animation-delay-4000    
         ...
         h-[150vh] w-[50vw]
          ...
          />}
           {width>breakPointSmall &&<div className={`bg-green ${myWidth<640?'top-0 right-0':'animate-blob'} animation-delay-0000   
          h-[200vh] w-[66vw] 
