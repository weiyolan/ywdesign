...
export default function RoadmapD({ scrollMin, scrollMax, speed }) {
    ...
    return (
      ...
      <SVGWrapper myRatio={allRatios} prevRatio={allPrevRatios} scrollMin={scrollMin} scrollMax={scrollMax} animationSpeed={speed}>
        <div className='relative w-full h-fit flex flex-col '>
          ...
          <svg className='relative w-full px-4 left-1/2' style={{ transform: `translate(-50%, ${-0 * scrolled}px)` }} viewBox="0 0 810 1116" fill="none" xmlns="http://www.w3.org/2000/svg">
          <g id="Frame 19">
          <g id="iterationGroup">
          ...
          <Path lineSpeed={1.2} position={5}  inverse={false}  double={1} handleLength={(l,i)=>handleLength(0.1,l,i)} id="Arrow" d="M407.5 346C407.5 464.5 606 425 606 517.5C606 610 250.5 558 250.5 669.5C250.5 781 484 741 484 805C484 869 380.5 869 380.5 916.5C380.5 964 406.5 964 406.5 1055M406.5 1055L412 1047.5M406.5 1055L400.5 1047.5" stroke="url(#paint0_linear_652_2278)" strokeWidth="3" strokeLinecap="round" initialDash="6 6"/>
          
          <AnimateSVGText at={0.345} fromTop={false}>
            <Text id="Iteration" transform="translate(477 335)" fill="black" style="white-space: pre" font-family="Work Sans" font-size="44.0504" font-weight="500" letter-spacing="0em"><tspan x="0.0276794" y="41.1313">Iteration</tspan></Text>
          </AnimateSVGText>
