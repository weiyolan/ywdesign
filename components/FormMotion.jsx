    ...
    <motion.form initial='hidden' whileInView='visible' variants={variant} viewport={{once:false}} className='flex flex-col items-start'>
      ...
      <div className='grid gap-6 grid-cols-3 w-full min-w-[30vw] auto-rows-min'>
        <div  className='inline-block relative col-start-1 col-span-1 '>
          ...
          <motion.input whileFocus='focus' variants={inputVariants} required name='name' className={`block bg-white/10 font-normal text-primary placeholder:text-primary
            ${!noBlur && ' backdrop-blur-md focus:backdrop-blur-sm '} shadow-xl focus:shadow-sm target:outline-primary rounded-2xl
           autofill:bg-white/10 valid:shadow-sm valid:scale-[0.99] 
        ...
        <div  className='inline-block relative col-start-2 col-span-1 '>
          ...
          <motion.input whileFocus='focus' variants={inputVariants} required name='lastname' 
          className={`bg-white/10 font-normal w-full text-primary placeholder:text-primary
           p-2 my-2
           ${!noBlur && ' backdrop-blur-md focus:backdrop-blur-sm '} shadow-xl valid:shadow-sm focus:shadow-sm target:outline-primary rounded-2xl
        ...
        <div  className='inline-block relative col-start-1 col-span-2'>
          ...
          <motion.input whileFocus='focus' variants={inputVariants} required name='email' className={`bg-white/10 font-normal  text-primary placeholder:text-primary
        ...
        <div className='inline-flex flex-col w-full col-start-1 col-span-3 '>
          ...
          <motion.textarea whileFocus='focus' variants={inputVariants} required className={`bg-white/10 font-normal  text-primary placeholder:text-primary 
          ${!noBlur && ' backdrop-blur-md focus:backdrop-blur-sm '} shadow-xl focus:shadow-sm target:outline-primary rounded-2xl
          autofill:bg-white/10 valid:shadow-sm valid:scale-[0.99]
            outline-none -outline-offset-2 focus:outline-none focus:animate-outlinePulse
            border border-transparent   invalid:text-pink-600
      ...
      {/* BUTTON */}
        <div className='flex col-start-3 row-start-2 justify-start items-end'>
          <motion.div variants={inputVariants} whileHover='hover' className={`inline-flex shadow-xl my-2
